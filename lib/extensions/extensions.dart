...
extension Help on int {
  ...
  String get withInsertedCommas1 =>
      string.replaceAllMapped(insCom1, (Match match) => '$match,');

  String get withInsertedCommas2 =>
      string.replaceAllMapped(insCom2, (Match match) => '$match,');

  String get withInsertedCommasInWesternSystem => string.replaceAllMapped(
      insertCommasWesternSystemExp, (Match match) => '${match[1]},');
